...
static const char *driverName = "NDFileHDF5Batch";
...
static herr_t cFlushCallback(hid_t objectID, void *data)
{
  ...
  NDFileHDF5Batch *ptr = (NDFileHDF5Batch *)data;
...
const char *NDFileHDF5Batch::str_NDFileHDF5_chunkSize[MAX_CHUNK_DIMS] = {
    "HDF5_nColChunks",
    "HDF5_nRowChunks",
    "HDF5_chunkSize2",
    "HDF5_chunkSize3",
...
const char *NDFileHDF5Batch::str_NDFileHDF5_extraDimSize[MAXEXTRADIMS] = {
    "HDF5_extraDimSizeN",
    "HDF5_extraDimSizeX",
    "HDF5_extraDimSizeY",
    "HDF5_extraDimSize3",
...
const char *NDFileHDF5Batch::str_NDFileHDF5_extraDimName[MAXEXTRADIMS] = {
    "HDF5_extraDimNameN",
    "HDF5_extraDimNameX",
    "HDF5_extraDimNameY",
    "HDF5_extraDimName3",
...
const char *NDFileHDF5Batch::str_NDFileHDF5_extraDimChunk[MAXEXTRADIMS] = {
    "HDF5_extraDimChunkN",
    "HDF5_extraDimChunkX",
    "HDF5_extraDimChunkY",
    "HDF5_extraDimChunk3",
...
const char *NDFileHDF5Batch::str_NDFileHDF5_posName[MAXEXTRADIMS] = {
    "HDF5_posNameDimN",
    "HDF5_posNameDimX",
    "HDF5_posNameDimY",
    "HDF5_posNameDim3",
...
const char *NDFileHDF5Batch::str_NDFileHDF5_posIndex[MAXEXTRADIMS] = {
    "HDF5_posIndexDimN",
    "HDF5_posIndexDimX",
    "HDF5_posIndexDimY",
    "HDF5_posIndexDim3",
...
{
    NDFileHDF5Batch *pPlugin = (NDFileHDF5Batch *)drvPvt;
    pPlugin->flushTask();
}
 ...
 */
asynStatus NDFileHDF5Batch::openFile(const char *fileName, NDFileOpenMode_t openMode, NDArray *pArray)
{
 ...
 */
void NDFileHDF5Batch::flushTask()
{
...
asynStatus NDFileHDF5Batch::startSWMR()
{
...
asynStatus NDFileHDF5Batch::flushCallback()
{
  int counter = 0;
  this->lock();
 ...
 */
asynStatus NDFileHDF5Batch::createXMLFileLayout()
{
 ...
 */
asynStatus NDFileHDF5Batch::storeOnOpenAttributes()
{
  asynStatus status = asynSuccess;
 ...
 */
asynStatus NDFileHDF5Batch::storeOnCloseAttributes()
{
  asynStatus status = asynSuccess;
 ...
 */
asynStatus NDFileHDF5Batch::storeOnOpenCloseAttribute(hdf5::Element *element, bool open)
{
  asynStatus status = asynSuccess;
  NDAttribute *ndAttr = NULL;
  void* datavalue;
 ...
 *
 */
asynStatus NDFileHDF5Batch::createTree(hdf5::Group* root, hid_t h5handle)
{
  asynStatus retcode = asynSuccess;
  int storeAttributes;
 ...
 *
 */
asynStatus NDFileHDF5Batch::createHardLinks(hdf5::Group* root)
{
  asynStatus retcode = asynSuccess;
 ...
 *
 */
void NDFileHDF5Batch::writeHdfAttributes( hid_t h5_handle, hdf5::Element* element)
{
  hdf5::Element::MapAttributes_t::iterator it_attr;
...
hid_t NDFileHDF5Batch::writeHdfConstDataset( hid_t h5_handle, hdf5::Dataset* dset)
{
 ...
 */
hid_t NDFileHDF5Batch::writeH5dsetStr(hid_t element, const std::string &name, const std::string &str_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfdset = -1;
...
hid_t NDFileHDF5Batch::writeH5dsetInt32(hid_t element, const std::string &name, const std::string &str_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfdset = -1;
...
hid_t NDFileHDF5Batch::writeH5dsetFloat64(hid_t element, const std::string &name, const std::string &str_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfdset = -1;
 ...
 */
hid_t NDFileHDF5Batch::createDataset(hid_t group, hdf5::Dataset *dset)
{
  hid_t retcode = -1;
 ...
 */
void NDFileHDF5Batch::writeH5attrStr(hid_t element, const std::string &attr_name, const std::string &str_attr_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfattr = -1;
 ...
 */
void NDFileHDF5Batch::writeH5attrInt32(hid_t element, const std::string &attr_name, const std::string &str_attr_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfattr = -1;
 ...
 */
void NDFileHDF5Batch::writeH5attrFloat64(hid_t element, const std::string &attr_name, const std::string &str_attr_value) const
{
  herr_t hdfstatus = -1;
  hid_t hdfdatatype = -1;
  hid_t hdfattr = -1;
 ...
 */
hid_t NDFileHDF5Batch::fromHdfToHidDatatype(hdf5::DataType_t in) const
{
  hid_t out;
  switch(in)
  {
 ...
 */
hid_t NDFileHDF5Batch::createDatasetDetector(hid_t group, hdf5::Dataset *dset)
{
...
/** Writes NDArray data to a HDF5 file.
  ...
  *            openMode in the call to NDFileHDF5Batch::openFile.
  */
asynStatus NDFileHDF5Batch::writeFile(NDArray *pArray)
{
  herr_t hdfstatus = 0;
  asynStatus status = asynSuccess;
...
asynStatus NDFileHDF5Batch::readFile(NDArray **pArray)
{
  //static const char *functionName = "readFile";
  return asynError;
}

/** Closes the HDF5 file opened with NDFileHDF5Batch::openFile
 */
asynStatus NDFileHDF5Batch::closeFile()
{
  int storeAttributes, storePerformance;
  epicsTimeStamp now;
 ...
 */
asynStatus NDFileHDF5Batch::writeInt32(asynUser *pasynUser, epicsInt32 value)
{
  int addr=0;
  int oldvalue = 0;
    ...
    if (function < FIRST_NDFILE_HDF5_PARAM)
    {
      ...
      asynPrint(pasynUser, ASYN_TRACE_FLOW,
                "%s:%s: calling base class function=%d, value=%d old=%d\n",
                 driverName, functionName, function, value, oldvalue);
      status = NDPluginFileBatch::writeInt32(pasynUser, value);
      return status;
    }
  }
...
asynStatus NDFileHDF5Batch::writeOctet(asynUser *pasynUser, const char *value, size_t nChars, size_t *nActual)
{
  int addr=0;
  int function = pasynUser->reason;
  asynStatus status = asynSuccess;
  ...
  if (function == NDFileHDF5_layoutFilename){
    status = (asynStatus)this->verifyLayoutXMLFile();
      ...
      /* If this parameter belongs to a base class call its method */
      status = NDPluginFileBatch::writeOctet(pasynUser, value, nChars, nActual);
  }
 ...
 */
int NDFileHDF5Batch::fileExists(char *filename)
{
  struct stat buffer;
 ...
 */
int NDFileHDF5Batch::verifyLayoutXMLFile()
{
...
/** Return the requested dimension size.
  ...
  */
hsize_t NDFileHDF5Batch::getDim(int index)
{
  hsize_t value = -1;
...
/** Return the requested max dimension size.
  ...
  * \return size of the dimension
  */
hsize_t NDFileHDF5Batch::getMaxDim(int index)
{
  hsize_t value = -1;
  if (index >= 0 && index < this->rank){
...
/** Return the requested chunk dimension size.
  ...
  * \return size of the dimension
  */
hsize_t NDFileHDF5Batch::getChunkDim(int index)
{
  hsize_t value = -1;
  if (index >= 0 && index < this->rank){
...
/** Return the requested offset size.
  ...
  */
hsize_t NDFileHDF5Batch::getOffset(int index)
{
  hsize_t value = -1;
  if (index >= 0 && index < this->rank){
...
/** Return the requested virtual dimension size.
  ...
  * \return size of the dimension
  */
hsize_t NDFileHDF5Batch::getVirtualDim(int index)
{
  hsize_t value = -1;
...
/** Set the multi frame parameter.
  ...
  */
void NDFileHDF5Batch::setMultiFrameFile(bool multi)
{
...
/** Constructor for NDFileHDF5; parameters are identical to those for NDPluginFile::NDPluginFile,
  ...
  */
NDFileHDF5Batch::NDFileHDF5Batch(const char *portName, int queueSize, int blockingCallbacks,
  ...
  : NDPluginFileBatch(portName, queueSize, blockingCallbacks,
 ...
 */
void NDFileHDF5Batch::calcNumFrames()
{
...
unsigned int NDFileHDF5Batch::calcIstorek()
{
...
hsize_t NDFileHDF5Batch::calcChunkCacheBytes()
{
  hsize_t nbytes = 0;
...
hsize_t NDFileHDF5Batch::calcChunkCacheSlots()
{
 ...
 */
asynStatus NDFileHDF5Batch::configurePerformanceDataset()
{
 ...
 */
asynStatus NDFileHDF5Batch::createPerformanceDataset()
{
  hsize_t dims[2];
  ...
  if (root){
    ...
    if (!H5Iis_valid(this->perf_dataset_id)) {
        asynPrint(this->pasynUserSelf, ASYN_TRACE_WARNING, "NDFileHDF5Batch::writePerformanceDataset: unable to create \'timestamp\' dataset.");
 ...
 */
asynStatus NDFileHDF5Batch::writePerformanceDataset()
{
  hsize_t dims[2];
  epicsInt32 numCaptured;
 ...
 *
 */
asynStatus NDFileHDF5Batch::createAttributeDataset(NDArray *pArray)
{
  NDAttribute *ndAttr = NULL;
...
asynStatus NDFileHDF5Batch::calculateAttributeChunking(int *chunking, int *mdim_chunking)
{
  int fileWriteMode = 0;
  int dim1Size = 0;
  this->lock();
 ...
 *
 */
asynStatus NDFileHDF5Batch::writeAttributeDataset(hdf5::When_t whenToSave, int positionMode, hsize_t *offsets)
{
  asynStatus status = asynSuccess;
  NDAttribute *ndAttr = NULL;
  int flush = 0;
 ...
 */
asynStatus NDFileHDF5Batch::closeAttributeDataset()
{
  asynStatus status = asynSuccess;
 ...
 */
asynStatus NDFileHDF5Batch::writeStringAttribute(hid_t element, const char * attrName, const char* attrStrValue)
{
  asynStatus status = asynSuccess;
  hid_t hdfdatatype;
  hid_t hdfattr;
 ...
 *  created.
 */
asynStatus NDFileHDF5Batch::configureDatasetDims(NDArray *pArray)
{
  int i = 0;
  int extradims = 0;
  int *numCapture=NULL;
 ...
 */
asynStatus NDFileHDF5Batch::configureDims(NDArray *pArray)
{
 ...
 */
asynStatus NDFileHDF5Batch::configureCompression(NDArray *pArray)
{
  asynStatus status = asynSuccess;
 ...
 */
asynStatus NDFileHDF5Batch::configureDatasetCompression()
{
 ...
 */
hid_t NDFileHDF5Batch::typeNd2Hdf(NDDataType_t datatype)
{
  hid_t result;
 ...
 */
char* NDFileHDF5Batch::getDimsReport()
{
...
void NDFileHDF5Batch::report(FILE *fp, int details)
{
  fprintf(fp, "Dimension report: %s\n", this->getDimsReport());
  // Call the base class report
  NDPluginFileBatch::report(fp, details);
}
                                   ...
                                   int priority, int stackSize)
{
  ...
  NDFileHDF5Batch *pPlugin = new NDFileHDF5Batch(portName, queueSize, blockingCallbacks, NDArrayPort, NDArrayAddr,
                                       priority, stackSize);
  return pPlugin->start();
}

void NDFileHDF5Batch::checkForOpenFile()
{
...
bool NDFileHDF5Batch::checkForSWMRMode()
{
  int SWMRMode = 0;
...
bool NDFileHDF5Batch::checkForSWMRSupported()
{
 ...
 * epicsTS.nsec.
 */
void NDFileHDF5Batch::addDefaultAttributes(NDArray *pArray)
{
 ...
 *
 */
asynStatus NDFileHDF5Batch::writeDefaultDatasetAttributes(NDArray *pArray)
{
...
asynStatus NDFileHDF5Batch::createNewFile(const char *fileName)
{
  herr_t hdfstatus;
  int tempAlign = 0;
  int tempThreshold = 0;
 ...
 */
asynStatus NDFileHDF5Batch::createFileLayout(NDArray *pArray)
{
  hid_t hdfdatatype;
...
int NDFileHDF5Batch::isAttributeIndex(const std::string& attName)
{
  int index = -1;
  int extraDims = 0;
...
epicsInt32 NDFileHDF5Batch::findPositionIndex(NDArray *pArray, char *posName)
{
...
extern "C" void NDFileHDF5BatchRegister(void)
{
  iocshRegister(&initFuncDef,initCallFunc);
}

extern "C" {
epicsExportRegistrar(NDFileHDF5BatchRegister);
}
